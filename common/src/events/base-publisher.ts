...
export abstract class Publisher<T extends IEvent> {
  ...
  // 396. Publishing While Listening
  // https://www.udemy.com/course/microservices-with-node-js-and-react/learn/lecture/19565240#questions
    ...
    return new Promise((resolve, reject) => {
      ...
      this.stanClient.publish(
        ...
        (err, guid) => {
          ...
          console.log(
            "(from Common Module->Base Publisher:) Event published with subject",
            this.subject
          );

          console.log(
            "(from Common Module->Base Publisher:) Event guid:",
            guid
          );
          resolve();
        }
